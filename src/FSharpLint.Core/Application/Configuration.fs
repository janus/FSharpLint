...
type ConventionsConfig =
    { recursiveAsyncFunction:EnabledConfig option
      ...
      avoidTypeHintSuffixesForNames:EnabledConfig option
...
with
    member this.Flatten() =
        [|
            ...
            this.avoidTypeHintSuffixesForNames |> Option.bind (constructRuleIfEnabled AvoidTypeHintSuffixesForNames.rule) |> Option.toArray
...
with
    static member Zero = {
        ...
        FavourReRaise = None
        AvoidTypeHintSuffixesForNames = None
...
let flattenConfig (config:Configuration) =
    ...
    let allRules =
        [|
            ...
            config.AvoidTypeHintSuffixesForNames |> Option.bind (constructRuleIfEnabled AvoidTypeHintSuffixesForNames.rule)
