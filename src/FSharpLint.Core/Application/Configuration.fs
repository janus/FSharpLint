...
type ConventionsConfig =
    { recursiveAsyncFunction:EnabledConfig option
      ...
      genericTypesNormalization:EnabledConfig option
...
with
    member this.Flatten() =
        [|
            ...
            this.genericTypesNormalization |> Option.bind (constructRuleIfEnabled GenericTypesNormalization.rule) |> Option.toArray         
...
with
    static member Zero = {
        ...
        GenericTypesNormalization = None
...
let flattenConfig (config:Configuration) =
    ...
    let allRules =
        [|
            ...
            config.GenericTypesNormalization |> Option.bind (constructRuleIfEnabled GenericTypesNormalization.rule)
